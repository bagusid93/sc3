...
# ==================================================
# Link Hosting Kalian
julak="raw.githubusercontent.com/bagusid93/sc3/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${julak}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${julak}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${julak}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${julak}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${julak}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${julak}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
