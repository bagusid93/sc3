#!/bin/bash
#AutoScript By Julak Bantur
#Supported By Papada'an Store
...
Exp1=$(curl https://raw.githubusercontent.com/ppnhss/hss/main/sc3 | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
    sts="${Info}"
else
    sts="${Error}"
...
export sem=$( curl -s https://raw.githubusercontent.com/ppnhss/sc3/main/versi)
...
clear
echo -e "${BICyan}   _ (`-.    ('-.      _ (`-.    ('-.     _ .-') _     ('-.         ('-.         .-') _               .-')    .-') _                _  .-')     ('-.   ${NC}"
echo -e "${BICyan}  ( (OO  )  ( OO ).-. ( (OO  )  ( OO ).-.( (  OO) )   ( OO ).-.,--.( OO ).-.    ( OO ) )             ( OO ). (  OO) )              ( \( -O )  _(  OO)  ${NC}"
echo -e "${BICyan} _.`     \  / . --. /_.`     \  / . --. / \     .'_   / . --. /\  |/ . --. /,--./ ,--,'             (_)---\_)/     '._  .-'),-----. ,------. (,------. ${NC}"
echo -e "${BICyan}(__...--''  | \-.  \(__...--''  | \-.  \  ,`'--..._)  | \-.  \  `-'| \-.  \ |   \ |  |\             /    _ | |'--...__)( OO'  .-.  '|   /`. ' |  .---' ${NC}"
echo -e "${BICyan} |  /  | |.-'-'  |  ||  /  | |.-'-'  |  | |  |  \  '.-'-'  |  |  .-'-'  |  ||    \|  | )            \  :` `. '--.  .--'/   |  | |  ||  /  | | |  |     ${NC}"
echo -e "${BICyan} |  |_.' | \| |_.'  ||  |_.' | \| |_.'  | |  |   ' | \| |_.'  |   \| |_.'  ||  .     |/              '..`''.)   |  |   \_) |  |\|  ||  |_.' |(|  '--.  ${NC}"
echo -e "${BICyan} |  .___.'  |  .-.  ||  .___.'  |  .-.  | |  |   / :  |  .-.  |    |  .-.  ||  |\    |              .-._)   \   |  |     \ |  | |  ||  .  '.' |  .--'  ${NC}"
echo -e "${BICyan} |  |       |  | |  ||  |       |  | |  | |  '--'  /  |  | |  |    |  | |  ||  | \   |              \       /   |  |      `'  '-'  '|  |\  \  |  `---. ${NC}"
echo -e "${BICyan} `--'       `--' `--'`--'       `--' `--' `-------'   `--' `--'    `--' `--'`--'  `--'               `-----'    `--'        `-----' `--' '--' `------' ${NC}"
...
echo -e "♣${BIYellow} Whatsapp            👉 ${BIWhite}081250851741${NC}"
echo -e "♣${BIYellow} AutoScript By       👉 ${BIPurple}PAPADA'AN STORE${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo -e "     ${BICyan} SSH ${NC}: $ressh"" ${BICyan} NGINX ${NC}: $resngx"" ${BICyan}  XRAY ${NC}: $resv2r"" ${BICyan} TROJAN ${NC}: $resv2r"
echo -e "   ${BICyan}     STUNNEL ${NC}: $resst" "${BICyan} DROPBEAR ${NC}: $resdbr" "${BICyan} SSH-WS ${NC}: $ressshws"
echo -e " ${BICyan}┌──────────────────────────────────────────────────┐${NC}" 
echo -e " ${BICyan}│    \033[0m ${BOLD}${YELLOW}SSH     VMESS       VLESS      TROJAN $NC" 
echo -e " ${BICyan}│    \033[0m ${Blue} $ssh1        $vmc           $vlx          $trx   $NC" 
echo -e " ${BICyan}└──────────────────────────────────────────────────┘${NC}" 
...
echo -e " ${BICyan}│    [${BIWhite}03${BICyan}]${BICyan}[${BIYellow}Menu${BICyan}] VLESS   ${NC}"  "     ${BICyan}[${BIWhite}08${BICyan}]${BICyan}[${BIYellow}Menu${BICyan}] THEME    ${NC}" "${BICyan} │"
...
echo -e " ${BICyan}│    [${BIWhite}05${BICyan}]${BICyan}[${BIYellow}Menu${BICyan}] L2TP    ${NC}"  "     ${BICyan}[${BIWhite}10${BICyan}]${BICyan}[${BIYellow}Menu${BICyan}] SET REBOOT ${NC}" "${BICyan} │${NC}"
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
echo -e " ${BIYellow}                 🔥 MENU TAMBAHAN 🔥${NC} "
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e " ${BICyan}|    [${BIWhite}11${BICyan}] REGISTRASI IP BARU${NC} "
echo -e " ${BICyan}|    [${BIWhite}12${BICyan}] UPDATE SCRIPT${NC} "
echo -e " ${BICyan}|    [${BIWhite}13${BICyan}] BACKUP TO GITHUB${NC} "
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan}     $NC ${BICyan}HARI ini${NC}: ${red}$ttoday$NC ${BICyan}KEMARIN${NC}: ${red}$tyest$NC ${BICyan}BULAN${NC}: ${red}$tmon$NC $NC"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e " ${BICyan}┌─────────────────────────────────────┐${NC}"
echo -e " ${BICyan}│  Version      ${NC} :${BIWhite} ${sem} ${BICyan}Last Update ${NC}"
echo -e " ${BICyan}│  User         ${NC} :${BIYellow} ${Name} ${NC}"
echo -e " ${BICyan}│  Expired      ${NC} :${RED} ${Exp} ${GREEN}😢${NC}"
echo -e " ${BICyan}└─────────────────────────────────────┘${NC}"
echo ""
