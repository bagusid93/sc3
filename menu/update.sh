...
sleep 1
wget -q -O menu-update "https://${julak}/main/menu/menu-update.sh"
sleep 1
echo -e ""
sleep 1
echo -e ""
...
wget -O add-xray "https://${julak}/main/xray/add-vms.sh"
wget -O add-tru "https://${julak}/main/xray/add-tru.sh"
wget -q -O user-lock "https://${julak}/main/ssh/user-lock.sh"
wget -q -O user-unlock "https://${julak}/main/ssh/user-unlock.sh"
