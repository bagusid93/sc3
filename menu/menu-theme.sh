...
01 | 1)
clear
echo "blue" >/etc/julak/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
02 | 2)
clear
echo "red" >/etc/julak/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
03 | 3)
clear
echo "yellow" >/etc/julak/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
05 | 5)
clear
echo "green" >/etc/julak/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
06 | 6)
clear
echo "magenta" >/etc/julak/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
