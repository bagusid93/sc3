...
wget -O /etc/systemd/system/ws-ovpn.service https://raw.githubusercontent.com/bagusid93/sc3/main/OPENVPN/ws-ovpn.service && chmod +x /etc/systemd/system/ws-ovpn.service
