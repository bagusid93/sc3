...
curl "https://raw.githubusercontent.com/bagusid93/bantur/main/julak/insshws.sh" | bash



wget -O /usr/local/bin/edu-proxy https://raw.githubusercontent.com/bagusid93/bantur/main/julak/main/openssh.py && chmod +x /usr/local/bin/edu-proxy
